...
const ROWS = [
  /* --- the ones that did not arrive, which is why anybody opens this --- */
  {
    ...
    sentAt: null,
    attempts: 5,
    // Written for the platform, never rendered. Its presence here is the point:
    // the component must not put this in front of a client.
    error: "MESSAGING_RESEND_KEY is not set on this deployment.",
    providerName: null,
  ...
  },
  {
    ...
    sentAt: null,
    attempts: 0,
    error: "that number belongs to Example Renewables, a lead we are prospecting.",
    providerName: null,
